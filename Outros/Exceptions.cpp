/*
	...
	Exceptions são responsáveis pelo tratamento de exceções, é o mecanismo responsável pelo tratamento das ocorrências de 
	condições que alteram o fluxo normal da execução dos programas.
*/
